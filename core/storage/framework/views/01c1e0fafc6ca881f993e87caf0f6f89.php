        ...
        $(document).on("click", "#next", function (e){
            ...
            if (current <= Listings.length) {
                ...
                if(current == 1){
                    ...
                    let video = $('#upload_project_video').val();
                    // if (video == '') {
                    //     current = 2;
                    //     toastr_warning_js("<?php echo e(__('Please upload project video !')); ?>");
                    //     return false;
                    // }
                    // Update the footer with the submit button after the video step
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/user/freelancer/project/edit/edit-project-js.blade.php ENDPATH**/ ?>