    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.navbar-right-notification-icon', function () {
                ...
                <?php  $user_type =  Auth::guard('web')->check() && Auth::guard('web')->user()->user_type == 2 ? 'freelancer' : 'client'  ?>
                $.ajax({
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/layout/partials/footer.blade.php ENDPATH**/ ?>