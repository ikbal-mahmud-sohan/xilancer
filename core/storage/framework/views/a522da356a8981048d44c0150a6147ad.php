<?php $__env->startSection('site_title',__('Talents')); ?>
<?php $__env->startSection('meta_title'); ?><?php echo e(__('Talents')); ?><?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Talents') ?? __('Talents'),'innerTitle' => __('Talents') ?? '' ]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Talents') ?? __('Talents')),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Talents') ?? '' )]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div class="row g-4">
                    ...
                    <?php if(moduleExists('PromoteFreelancer')): ?>
                        <div class="profile-wrapper-right-flex flex-btn text-right">
                            <span class="profile-wrapper-switch-title"><?php echo e(__('Pro Profiles')); ?></span>
                    ...
                    <div class="col-lg-12">
                        <div class="categoryWrap-wrapper">
                            <div class="shop-contents-wrapper responsive-lg">
                                ...
                                <?php echo $__env->make('frontend.pages.talent.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                <div class="shop-contents-wrapper-right search_talent_result">
                                    <?php echo $__env->make('frontend.pages.talent.search-talent-result', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.pages.talent.talent-filter-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/pages/talent/talents.blade.php ENDPATH**/ ?>