                ...
                <div class="profile-wrapper-author-thumb position-relative">
                    <?php if($user->image): ?>
                        <a href="#/">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('assets/uploads/profile/'.$user->image)); ?>" alt="<?php echo e(__('profile img')); ?>">
                            <?php endif; ?>
                        </a>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="#/"><img src="<?php echo e(asset('assets/static/img/author/author.jpg')); ?>" alt="<?php echo e(__('AuthorImg')); ?>"></a>
                        <?php if(moduleExists('FreelancerLevel')): ?>
                            <?php if(get_static_option('profile_page_badge_settings') == 'enable'): ?>
                                <div class="freelancer-level-badge position-absolute">
                                    <?php echo freelancer_level($user->id,'talent') ?? ''; ?>
...
<?php endif; ?>
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/profile-details/profile.blade.php ENDPATH**/ ?>