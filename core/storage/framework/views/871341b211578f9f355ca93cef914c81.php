        ...
        if(messages_ != '' || file !== undefined){
            ...
            send_ajax_request("post", form, "<?php echo e(route("freelancer.message.send")); ?>", function (){}, function (response){
                ...
                if(response.status == 'image_not_allow_in_demo'){
                    toastr_warning_js("<?php echo e(__('This is demonstration purpose only, you may not able to send files in demo purpose, once your purchase this script you will get access to all settings.')); ?>");
                }
                scrollToBottom();
            }, function (){})
        }else{
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/Modules/Chat/Resources/views/components/freelancer/freelancer-chat-js.blade.php ENDPATH**/ ?>