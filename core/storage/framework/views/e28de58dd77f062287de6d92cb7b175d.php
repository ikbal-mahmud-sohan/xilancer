...
<?php endif; ?>
                        ...
                        <div class="categoryWrap-wrapper-item-contents">
                            <div class="obFilter-wrapper-item-contents-flex flex-between">
                                <?php if($job->type == 'hourly'): ?>
                                    <h3 class="single-jobs-price">
                                        <?php echo e(float_amount_with_currency_symbol($job->hourly_rate)); ?>
                    ...
                    <div class="categoryWrap-wrapper-item-bottom">
                        <ul class="categoryWrap-wrapper-item-bottom-list">
                            ...
                            <li class="categoryWrap-wrapper-item-bottom-list-item"><span class="item-icon">
                                ...
                                <span class="item-para"><?php echo e(__('Proposal:')); ?> <?php echo e($job->job_proposals_count ?? 0); ?></span>
                            </li>
                            ...
                            <li class="categoryWrap-wrapper-item-bottom-list-item">
                                ...
                                <?php if($job->job_creator?->user_wallet?->balance >= ($job->hourly_rate * $job->estimated_hours) ): ?>
                                    <span class="item-para"><?php echo e(__('Verified')); ?></span>
                                <?php else: ?>
                                    <span class="item-para"><?php echo e(__('Not Verified')); ?></span>
                                <?php endif; ?>
                            </li>
                            <?php endif; ?>
                            <li class="categoryWrap-wrapper-item-bottom-list-item">
                            ...
                            <?php if(moduleExists('HourlyJob')): ?>
                                <?php if($job->type == 'hourly'): ?>
                                    ...
                                    <span class="item-icon">
                                        ...
                                        <span class="item-para"><?php echo e(__('Estimated Hours:')); ?> <?php echo e(ucfirst(__($job->estimated_hours)) ?? ''); ?></span>
                                    </li>
                                <?php endif; ?>
                            <?php endif; ?>
                        </ul>
...
<?php endif; ?>
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/pages/jobs/search-job-result.blade.php ENDPATH**/ ?>