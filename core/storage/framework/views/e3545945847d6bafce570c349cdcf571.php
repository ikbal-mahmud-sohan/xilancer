    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#talent_filter_reset', function(e){
                ...
                $.ajax({
                    url:"<?php echo e(route('talents.filter.reset')); ?>",
                    method:'GET',
                    success:function(res){
                        if(res.status=='nothing'){
                            $('.search_talent_result').html('<h3 class="text-center text-danger">'+"<?php echo e(__('Nothing Found')); ?>"+'</h3>');
                        }else{
            ...
            function profiles(page=1){
                ...
                $.ajax({
                    url:"<?php echo e(route('talents.pagination').'?page='); ?>" + page,
                    method:'GET',
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/pages/talent/talent-filter-js.blade.php ENDPATH**/ ?>