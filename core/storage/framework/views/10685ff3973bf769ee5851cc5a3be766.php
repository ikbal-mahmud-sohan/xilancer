<?php $__env->startSection('site_title'); ?> <?php echo e($category->category ?? __('Category Projects')); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('meta_title'); ?><?php echo e($category->meta_title ?? ''); ?><?php $__env->stopSection(); ?>
<?php $__env->startSection('meta_description'); ?><?php echo e($category->meta_description ?? ''); ?><?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => $category->category ?? __('Project Category'),'innerTitle' => $category->category ?? '' ]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->category ?? __('Project Category')),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->category ?? '' )]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div class="col-lg-12">
                        <div class="categoryWrap-wrapper">
                            <div class="shop-contents-wrapper responsive-lg">
                                ...
                                <?php echo $__env->make('frontend.pages.category-projects.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <input type="hidden" id="category_id" value="<?php echo e($category->id ?? ''); ?>">
                                <div class="shop-contents-wrapper-right search_category_result">
                                    <?php echo $__env->make('frontend.pages.category-projects.search-category-result', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.pages.category-projects.category-project-filter-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/pages/category-projects/projects.blade.php ENDPATH**/ ?>