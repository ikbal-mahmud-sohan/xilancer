        ...
        <div class="single-setup-request">
            <ul class="single-setup-request-list list-style-none">
                ...
                <li class="single-setup-request-list-item">
                    ...
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title"><?php echo e(__('Upload video')); ?></h5>
                        <p class="single-setup-request-list-item-contents-para"><?php echo e(__('Add a video to your project')); ?></p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/user/freelancer/project/edit/project-sidebar.blade.php ENDPATH**/ ?>