        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            let all_options = "<option value=''><?php echo e(__('Select Subcategory')); ?></option>";
            ...
            $(document).on('click','.basic_price_setup',function(){
                ...
                if(basic_discount_charge != '' && basic_discount_charge > 0){
                    $('.basic_discount_charge').html('<span class="basic_discount_charge"><s>' + '<?php echo e(site_currency_symbol()); ?>' +basic_discount_charge + '</s></span>');
                }else {
            ...
            $(document).on('click','.standard_price_setup',function(){
                ...
                if(standard_discount_charge != '' && standard_discount_charge > 0){
                    $('.standard_discount_charge').html('<span class="standard_discount_charge"><s>' + '<?php echo e(site_currency_symbol()); ?>' +standard_discount_charge + '</s></span>');
                }else {
            ...
            $(document).on('click','.premium_price_setup',function(){
                ...
                if(premium_discount_charge != '' && premium_discount_charge > 0){
                    $('.premium_discount_charge').html('<span class="premium_discount_charge"><s>' + '<?php echo e(site_currency_symbol()); ?>' +premium_discount_charge + '</s></span>');
                }else {
            ...
            $(document).on('click','#confirm_create_project',async function(e){
               ...
               let checkbox_or_numeric_title = $('.checkbox_or_numeric_title').val();
                ...
                let basic_regular_charge = $('#basic_regular_charge').val();
                if(basic_regular_charge == '' || basic_regular_charge <= 0) {
                    toastr_warning_js("<?php echo e(__('Basic regular price is required!')); ?>");
                    return false;
                }
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/user/freelancer/project/create/project-js.blade.php ENDPATH**/ ?>