...
<?php if(isset($project->meta_title) && !empty($project->meta_title)): ?>
    <?php $__env->startSection('meta_title', $project->meta_title); ?>
<?php endif; ?>

<?php if(isset($project->meta_description) && !empty($project->meta_description)): ?>
    <?php $__env->startSection('meta_description', $project->meta_description); ?>
<?php endif; ?>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        ...
                        <div class="project-preview-thumb">
                            ...
                            <div class="project-preview-contents mt-4">
                                ...
                                <h1 class="project-preview-contents-title mt-3"> <?php echo e($project->title); ?></h1>
                                        ...
                                        <div class="jobFilter-proposal-author-thumb position-relative">
                                            <?php if($user->image): ?>
                                                <a href="<?php echo e(route('freelancer.profile.details', $user->username)); ?>">
                                                    <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                        <img src="<?php echo e(render_frontend_cloud_image_if_module_exists('profile/'.$user->image, load_from: $user->load_from)); ?>" alt="<?php echo e($user->first_name ?? ''); ?>">
                                                    <?php else: ?>
                                            ...
                                            <div class="pricing-wrapper-card-bottom">
                                                <div class="pricing-wrapper-card-bottom-list">
                                                    <ul class="list-style-none">
                                                        <li><span><?php echo e(__('Revisions')); ?></span></li>
                                                        <li><span><?php echo e(__('Delivery time')); ?></span></li>
                                                        <?php $__currentLoopData = $project->project_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><span><?php echo e($attr->check_numeric_title); ?></span></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <li><span><?php echo e(__('Charges')); ?></span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/pages/project-details/project-details.blade.php ENDPATH**/ ?>