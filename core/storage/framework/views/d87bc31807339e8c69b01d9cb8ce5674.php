...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Edit Project'),'innerTitle' => __('Edit Project')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="container">
                <div class="setup-wrapper create-project-wrap">
                    <div class="setup-wrapper-flex">
                        <?php echo $__env->make('frontend.user.freelancer.project.edit.project-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('freelancer.project.edit',$project_details->id )); ?>" id="submit_edit_project_form" method="post" enctype="multipart/form-data">
                                ...
                                <?php echo $__env->make('frontend.user.freelancer.project.edit.project-introduction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('frontend.user.freelancer.project.edit.project-image', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('frontend.user.freelancer.project.edit.project-video', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('frontend.user.freelancer.project.edit.project-package-charge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('frontend.user.freelancer.project.edit.project-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.user.freelancer.project.edit.edit-project-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/user/freelancer/project/edit/edit-project.blade.php ENDPATH**/ ?>