                            ...
                            <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                <?php if($project->video): ?>
                                    ...
                                    <video controls class="single-project-thumb">
                                        <source src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'project/'.$project->video, load_from: $project->load_from)); ?>" type="video/mp4">
                                        <?php echo e(__('Your browser does not support the video tag.')); ?>

                                    </video>
                                <?php else: ?>
                                    <!-- Show Image if no video -->
                                    <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'project/'.$project->image, load_from: $project->load_from)); ?>" alt="project">
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if($project->video): ?>
                                    <!-- Show Video if available -->
                                    <video controls class="single-project-thumb">
                                        <source src="<?php echo e(url('core/public/assets/uploads/project/'.$project->video)); ?>" type="video/mp4">
                                        <?php echo e(__('Your browser does not support the video tag.')); ?>

                                    </video>
                                <?php else: ?>
                                    <!-- Show Image if no video -->
                                    <img src="<?php echo e(url('assets/uploads/project/'.$project->image)); ?>" alt="project">
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="single-project-content project-catalogue-contents mt-0">
                        ...
                        <div class="project-catalogue-bottom flex-between mt-3">
                            ...
                            <span class="single-project-delivery-icon">
                                ...
                                <span class="single-project-delivery-days"> <?php echo e(__($project->basic_delivery) ?? 0); ?> </span>
                            </div>
                        </div>
...
<?php endif; ?>
        ...
        <?php else: ?>
            <?php if($project->project_on_off == 1 && $project->status == 1 && $project->project_approve_request == 1): ?>
                <div class="single-project project-catalogue sss">
                <div class="project-catalogue-flex">
                    <div class="single-project-thumb project-catalogue-thumb">
                        <a href="<?php echo e(route('project.details',['username'=>$project->project_creator?->username,'slug'=>$project->slug])); ?>">
                            <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                    ...
                    <div class="single-project-content project-catalogue-contents mt-0">
                        <h4 class="single-project-content-title">
                            <a href="<?php echo e(route('project.details',['username'=>$project->project_creator?->username,'slug'=>$project->slug])); ?>"> <?php echo e($project->title); ?> sssd</a>
                        </h4>
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/profile-details/project.blade.php ENDPATH**/ ?>