        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#check_work_availability',function(e){
                ...
                Swal.fire({
                    ...
                    text: "<?php echo e(__('To change work availability status !')); ?>",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.work.availability.status')); ?>",
                            method:'post',
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    ...
                                    toastr_success_js("<?php echo e(__('Work Availability Status Successfully Changed')); ?>")
                                }
                            }
                        })
                    }
            ...
            $('#professional_title').on('keydown keyup change', function(){
                ...
                if(professional_title_length < title_min_length){
                    $('#professional_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ title_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(professional_title_length > title_max_length){
                    $('#professional_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ title_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#professional_title_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $('#professional_description').on('keydown keyup change', function(){
                ...
                if(professional_description_length < description_min_length){
                    $('#professional_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ description_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(professional_description_length > description_max_length){
                    $('#professional_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ description_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#professional_description_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $(document).on('click','.edit_public_profile_info',function(e){
                ...
                if(first_name == '' || last_name =='' || title == '' || description == '' || country_id==''){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('freelancer.profile.details.update')); ?>",
                        method:'post',
            ...
            $(document).on('click','.edit_public_hourly_rate',function(e){
                ...
                if(hourly_rate == ''){
                    toastr_warning_js("<?php echo e(__('price is required.')); ?>")
                    return false;
                }else{
                    $.ajax({
                        url:"<?php echo e(route('freelancer.profile.details.hourly.rate.update')); ?>",
                        method:'post',
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                toastr_success_js("<?php echo e(__('Price Successfully Updated')); ?>")
                            }
                        },
                        error:function(err){
                            let error = err.responseJSON;
            ...
            document.querySelector('#upload_portfolio_photo').addEventListener('change', function() {
                $("#add_portfolio_form").find('.change_image_text').text("<?php echo e(__('Click to change photo')); ?>")
            ...
            $('#portfolio_title').on('keydown keyup change', function(){
                ...
                if(portfolio_title_length < title_min_length){
                    $('#portfolio_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ title_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(portfolio_title_length > title_max_length){
                    $('#portfolio_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ title_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#portfolio_title_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $('#portfolio_description').on('keydown keyup change', function(){
                ...
                if(portfolio_description_length < description_min_length){
                    $('#portfolio_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ description_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(portfolio_description_length > description_max_length){
                    $('#portfolio_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ description_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#portfolio_description_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $(document).on('submit','#add_portfolio_form',function(e){
                ...
                if(image == '' || title == '' || description == ''){
                    toastr_warning_js("<?php echo e(__('Image, title and description fields are require')); ?>")
                    return false;
                }else{
                    $.ajax({
                        url:"<?php echo e(route('freelancer.portfolio.add')); ?>",
                        method:'post',
                        data:formData,
                        cache:false,
                        contentType: false,
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                toastr_success_js("<?php echo e(__('Portfolio Successfully Added')); ?>")
                            }
                        },
                        error:function(err){
                            let error = err.responseJSON;
            ...
            $(document).on('click','.view_portfolio_details',function(e){
                ...
                $.ajax({
                    url:"<?php echo e(route('freelancer.portfolio.details')); ?>",
                    method:'post',
            ...
            $('#edit_portfolio_title').on('keydown keyup change', function(){
                ...
                if(portfolio_title_length < title_min_length){
                    $('#edit_portfolio_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ title_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(portfolio_title_length > title_max_length){
                    $('#edit_portfolio_title_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ title_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#edit_portfolio_title_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $('#edit_portfolio_description').on('keydown keyup change', function(){
                ...
                if(portfolio_description_length < description_min_length){
                    $('#edit_portfolio_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is short, minimum')); ?> '+ description_min_length +' <?php echo e(__('required')); ?>.</p>');
                }else if(portfolio_description_length > description_max_length){
                    $('#edit_portfolio_description_char_length_check').html('<p class="text text-danger"><?php echo e(__('Length is not valid, maximum')); ?> '+ description_max_length +' <?php echo e(__('allowed')); ?>.</p>');
                }else{
                    $('#edit_portfolio_description_char_length_check').html('<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                }
            });
            ...
            $(document).on('submit','#edit_portfolio_form',function(e){
                ...
                if(image == '' || title == '' || description == ''){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('freelancer.portfolio.edit')); ?>",
                        method: 'post',
                        data: formData,
                        cache: false,
                        contentType: false,
                        ...
                        success: function (res) {
                            if(res.status=='success'){
                                ...
                                $('.portfolio_details_display').load(location.href + ' .portfolio_details_display');
                                toastr_success_js("<?php echo e(__('Portfolio Successfully Updated')); ?>")
                            }
                        },
                        error: function (err) {
                            let error = err.responseJSON;
            ...
            $(document).on('click','.delete_portfolio',function(e){
                ...
                Swal.fire({
                    title: "<?php echo e(__('Are you sure?')); ?>",
                    text: "<?php echo e(__('To delete this portfolio !')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.portfolio.delete')); ?>",
                            method:'post',
                            data:{id:portfolio_id},
                            success:function(res){
                                if(res.status == 'success'){
                                    $('.portfolio_details_display').load(location.href + ' .portfolio_details_display');
                                    toastr_delete_js("<?php echo e(__('Portfolio Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.delete_project',function(e){
                ...
                Swal.fire({
                    title: "<?php echo e(__('Are you sure?')); ?>",
                    text: "<?php echo e(__('To delete this project !')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.project.delete')); ?>",
                            method:'post',
                            data:{project_id:project_id},
                            success:function(res){
                                if(res.status == 'success'){
                                    $('.project_wrapper_area').load(location.href + ' .project_wrapper_area');
                                    toastr_delete_js("<?php echo e(__('Project Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            myTagInput.addData(["<?php echo e($array_skill[$i]); ?>"]);
            <?php endfor; ?>
            ...
            $(document).on('click','.update_freelancer_skill',function(){
                ...
                $.ajax({
                    url: "<?php echo e(route('freelancer.account.skill.add')); ?>",
                    type: 'post',
                    data: {skill: skill},
                    success: function(res){
                        if(res.status == 'ok'){
                            toastr_success_js("<?php echo e(__('Skill Successfully Updated')); ?>");
                            $('.edit_skill_wrapper').hide();
            ...
            $(document).on('click','.add_education',function(){
                ...
                if(institution == '' || degree == '' || subject == '' || start_date == '' || end_date == ''){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('freelancer.account.education.add')); ?>",
                        type: 'post',
                        data: {
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                toastr_success_js("<?php echo e(__('Education Successfully Added')); ?>");
                            }
                        }
                    });
                }
            ...
            $(document).on('click','.update_single_education',function(){
                ...
                if(institution == '' || subject == '' || degree == '' || start_date == '' || end_date == ''){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('freelancer.account.education.update')); ?>",
                        type: 'post',
                        data: {
                            id: id,
                            institution: institution,
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                toastr_success_js("<?php echo e(__('Education Successfully Updated')); ?>");
                                $('.popup-fixed, .popup-overlay').removeClass('popup-active');
                                $('#display_user_education_data').load(location.href + " #display_user_education_data");
            ...
            $(document).on('click','.delete_education',function(e){
                ...
                Swal.fire({
                    title: "<?php echo e(__('Are you sure?')); ?>",
                    text: "<?php echo e(__('To delete this education !')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.education.delete')); ?>",
                            method:'post',
                            data:{id:education_id},
                            success:function(res){
                                if(res.status == 'success'){
                                    $('#display_user_education_data').load(location.href + ' #display_user_education_data');
                                    toastr_delete_js("<?php echo e(__('Education Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.add_experience',function(){
                ...
                if(end_date != '' && start_date >end_date){
                    toastr_warning_js("<?php echo e(__('Start date must not greater than end date !')); ?>");
                    return false;
                }else{
                    $.ajax({
                        url: "<?php echo e(route('freelancer.account.experience.add')); ?>",
                        type: 'post',
                        data: {
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                $(addExperienceForm)[0].reset();
                                toastr_success_js("<?php echo e(__('Experience Successfully Added')); ?>");
                            }
                        }
                    });
                }
            ...
            $(document).on('click','.update_single_experience',function(){
                ...
                if(end_date != '' && start_date >end_date){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('freelancer.account.experience.update')); ?>",
                        type: 'post',
                        data: {
                            id: id,
                            experience_title: experience_title,
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                $('#display_user_experience_data').load(location.href + " #display_user_experience_data");
                                $(addExperienceForm)[0].reset();
                                toastr_success_js("<?php echo e(__('Experience Successfully Updated')); ?>");
                            }
                        }
                    });
                }
            ...
            $(document).on('click','.delete_experience',function(e){
                ...
                Swal.fire({
                    title: "<?php echo e(__('Are you sure?')); ?>",
                    text: "<?php echo e(__('To delete this experience !')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.experience.delete')); ?>",
                            method:'post',
                            data:{id:education_id},
                            success:function(res){
                                if(res.status == 'success'){
                                    $('#display_user_experience_data').load(location.href + ' #display_user_experience_data');
                                    toastr_delete_js("<?php echo e(__('Experience Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','#available_for_order_or_not',function(e){
                ...
                Swal.fire({
                    title: "<?php echo e(__('Are you sure?')); ?>",
                    text: "<?php echo e(__('To change availability status !')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url:"<?php echo e(route('freelancer.availability.status')); ?>",
                            method:'post',
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    ...
                                    toastr_success_js("<?php echo e(__('Availability Status Successfully Changed')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.view_as_a_client',function(){
                $('.change_client_view').html('<a href="javascript:void(0)" class="btn-profile btn-outline-gray view_original"> <?php echo e(__('Exit View as Client')); ?> </a>')
            ...
            $(document).on('click','.view_original',function(){
                $('.change_client_view').html('<a href="javascript:void(0)" class="btn-profile btn-outline-gray view_as_a_client"> <?php echo e(__('View as Client')); ?> </a>')
            ...
            $(document).on('click', '#get_package_budget, .wallet_selected_payment_gateway , .payment_getway_image ul li',function() {
                ...
                if(gateway == 'wallet' || gateway == 'manual_payment'){
                    ...
                    if(package_budget > wallet_balance){
                        $('.display_wallet_shortage_balance').html('<span class="text-danger"><?php echo e(__('Wallet Balance Shortage:')); ?>'+ site_default_currency_symbol + (package_budget-wallet_balance) +'<a class="btn btn-primary btn-sm ml-2" href="<?php echo e(route('freelancer.wallet.history')); ?>" target="_blank"><?php echo e(__('Deposit Wallet')); ?></a></span>');
                    }
                }else{
            ...
            $(document).on('click','.open_project_promote_modal',function(){
                ...
                if($('#set_project_id_for_promote').val() == 0){
                    $('.heading_title_for_promotion_modal').text("<?php echo e(__('Promote Profile')); ?>")
                    $('.warning_for_promotion_modal').text("<?php echo e(__("Notice: Days refers to the number of days a freelancer profile will be displayed in the talent page promotional area after he buy a package.")); ?>")
                }else{
                    $('.heading_title_for_promotion_modal').text("<?php echo e(__('Promote Project')); ?>")
                    $('.warning_for_promotion_modal').text("<?php echo e(__("Notice: Days refers to the number of days a freelancer project will be displayed in the project promotional area after he buy a package.")); ?>")
            ...
            $(document).on('click','.confirm_promote_project',function(){
                ...
                if(package_budget == ''){
                    toastr_warning_js("<?php echo e(__('Please choose package plan')); ?>")
                    return false;
                }
                if(payment_gateway == 'manual_payment'){
                    if(manual_payment_image == ''){
                        toastr_warning_js("<?php echo e(__('Please choose image for manual payment.')); ?>")
                        return false;
                    }
                }
...
<?php /**PATH /Users/mac/Desktop/Laravel/xilancer-v2.9.0/core/resources/views/frontend/profile-details/profile-details-js.blade.php ENDPATH**/ ?>