                                            ...
                                            <div id="marcado_pago_settings_content" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    <div class="switch">
                                                        ...
                                                        <label class="switch-label"
                                                               for="marcadopago_gateway">{{__('Enable/Disable Marcado Pago')}}</label>
                                                    </div>
                                                    <div class="switch">
                                                        ...
                                                        <label class="switch-label"
                                                               for="marcadopago_test_mode">{{__('Enable/Disable Test Mode Marcado Pago')}}</label>
                                                    </div>
                                                    <div class="single-input mt-3">
                                                        <x-backend.image :title="__('Marcado Pago Logo')"
                                                                         :name="'marcadopago_preview_logo'"
                                                                         :dimentions="'160x50'"/>
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="marcado_pago_client_id"
                                                               class="label-title mt-3">{{__('Marcado Pago Client ID')}}</label>
