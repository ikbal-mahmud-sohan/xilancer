...
{{--            <div class="navbar-right-flex">--}}
{{--                <div class="navbar-right-btn">--}}
{{--                    <a href="choose_account.html" class="cmn-btn btn-login search"> <i class="fa-solid fa-magnifying-glass"></i> </a>--}}
{{--                </div>--}}
{{--                <div class="navbar-right-btn">--}}
{{--                    <a href="choose_account.html" class="cmn-btn btn-login"> Log In </a>--}}
{{--                </div>--}}
{{--                <div class="btn-wrapper">--}}
{{--                    <a href="choose_account.html" class="cmn-btn btn-orange radius-10"> Sign Up </a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
