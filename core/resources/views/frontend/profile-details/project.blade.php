                            ...
                            @if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi']))
                                @if($project->video)
                                    ...
                                    <video controls class="single-project-thumb">
                                        <source src="{{ render_frontend_cloud_image_if_module_exists( 'project/'.$project->video, load_from: $project->load_from) }}" type="video/mp4">
        ...
        @else
            @if($project->project_on_off == 1 && $project->status == 1 && $project->project_approve_request == 1)
                ...
                <div class="project-catalogue-flex">
                    ...
                    <div class="single-project-content project-catalogue-contents mt-0">
                        <h4 class="single-project-content-title">
                            <a href="{{ route('project.details',['username'=>$project->project_creator?->username,'slug'=>$project->slug]) }}"> {{$project->title}} sssd</a>
                        </h4>
